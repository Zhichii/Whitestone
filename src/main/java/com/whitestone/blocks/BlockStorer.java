...
public class BlockStorer {
    public static class StorerBlock extends BlockAbstactWhitestone.AbstactWhitestoneBlock {
        public static final BooleanProperty POWERED;
        public static final DirectionProperty FACING;
        public StorerBlock(Settings settings) {
            super(settings);
        ...
        public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
            ...
            BlockState bs2 = world.getBlockState(pos.offset(state.get(FACING).getOpposite()));
            boolean a = false;
            boolean b = false;
            ...
            if (!a) {
                ...
                world.setBlockState(pos, cbs.with(POWERED, b));
            }
        }
